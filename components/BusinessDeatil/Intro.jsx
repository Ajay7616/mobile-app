  ...
  return (
    <View>
        <View style={{
            ...
            <TouchableOpacity onPress={()=>router.back()}><Ionicons name="arrow-back-circle" size={40} color="white" /></TouchableOpacity>
        ...
        <View style={{
            ...
            {user?.primaryEmailAddress?.emailAdress==business?.userEmail && <TouchableOpacity onPress={()=>OnDelete()}>
